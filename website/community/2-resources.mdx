...
- [docusaurus-plugin-llms](https://github.com/rachfop/docusaurus-plugin-llms) - A Docusaurus plugin for generating LLM-friendly documentation that follows [the llmstxt standard](https://llmstxt.org/).
